...
export function UsageRow({ label, used, max }: { label: string; used: number | null; max: number | null }) {
  const pct = used != null && max != null && max > 0 ? Math.min(100, Math.round((used / max) * 100)) : null;
